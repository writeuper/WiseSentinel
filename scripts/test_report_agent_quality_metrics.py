...
""")
    ...
    def test_tool_governance_reports_risk_outcomes_without_claiming_approval_binding(self):
        ...
        report = MODULE.aggregate_tool_governance([
            ...
            ["delete_data", "rejected", "0", "approval-1", "approved"], ["unknown", "success", "1"],
        ], policy)
        ...
        self.assertEqual(report["approval_state_counts"], {"approved": 1})
        ...
        self.assertEqual(missing["approval_state_counts"], {"missing_reference": 1})
